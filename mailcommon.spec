...
Version  : 21.08.3
Release  : 35
URL      : https://download.kde.org/stable/release-service/21.08.3/src/mailcommon-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/mailcommon-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/mailcommon-21.08.3.tar.xz.sig
...
%prep
%setup -q -n mailcommon-21.08.3
cd %{_builddir}/mailcommon-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636396327
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mailcommon-21.08.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/mailcommon/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/mailcommon-21.08.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/mailcommon/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/mailcommon-21.08.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/mailcommon/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/mailcommon-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/mailcommon/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/mailcommon-21.08.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/mailcommon/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/mailcommon/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/mailcommon/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/mailcommon/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/mailcommon/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/mailcommon/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/mailcommon/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/mailcommon-21.08.3/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/mailcommon/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/mailcommon-21.08.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/mailcommon/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailCommon.so.5.18.3
