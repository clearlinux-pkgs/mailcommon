...
Version  : 24.12.0
Release  : 109
URL      : https://download.kde.org/stable/release-service/24.12.0/src/mailcommon-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/mailcommon-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/mailcommon-24.12.0.tar.xz.sig
...
%setup -q -n mailcommon-24.12.0
cd %{_builddir}/mailcommon-24.12.0
pushd ..
cp -a mailcommon-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735339718
mkdir -p clr-build
pushd clr-build
...
/usr/include/KPim6/MailCommon/mailcommon/config-mailcommon.h
