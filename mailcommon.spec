...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/mailcommon-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/mailcommon-20.08.2.tar.xz.sig
...
%prep
%setup -q -n mailcommon-20.08.2
cd %{_builddir}/mailcommon-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602718464
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mailcommon-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/mailcommon/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/mailcommon-20.08.2/COPYING.LIB %{buildroot}/usr/share/package-licenses/mailcommon/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailCommon.so.5.15.2
