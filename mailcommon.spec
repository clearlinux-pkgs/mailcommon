...
%setup -q -n mailcommon-24.05.2
cd %{_builddir}/mailcommon-24.05.2
pushd ..
cp -a mailcommon-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720636394
mkdir -p clr-build
pushd clr-build
