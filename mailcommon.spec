...
Version  : 22.12.3
Release  : 54
URL      : https://download.kde.org/stable/release-service/22.12.3/src/mailcommon-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/mailcommon-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/mailcommon-22.12.3.tar.xz.sig
...
%prep
%setup -q -n mailcommon-22.12.3
cd %{_builddir}/mailcommon-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677804961
mkdir -p clr-build
pushd clr-build
...
/usr/include/KF5/MailCommon/MailCommon/MDNWarningJob
...
/usr/include/KF5/MailCommon/mailcommon/mdnwarningjob.h
...
/usr/lib64/libKF5MailCommon.so.5.22.3
