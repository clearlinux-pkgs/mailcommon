...
Version  : 22.12.1
Release  : 51
URL      : https://download.kde.org/stable/release-service/22.12.1/src/mailcommon-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/mailcommon-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/mailcommon-22.12.1.tar.xz.sig
...
%prep
%setup -q -n mailcommon-22.12.1
cd %{_builddir}/mailcommon-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673387097
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5MailCommon.so.5.22.1
