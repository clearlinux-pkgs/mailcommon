...
Version  : 20.08.0
Release  : 24
URL      : https://download.kde.org/stable/release-service/20.08.0/src/mailcommon-20.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.0/src/mailcommon-20.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.0/src/mailcommon-20.08.0.tar.xz.sig
...
%prep
%setup -q -n mailcommon-20.08.0
cd %{_builddir}/mailcommon-20.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597774753
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/mailcommon-20.08.0/COPYING %{buildroot}/usr/share/package-licenses/mailcommon/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/mailcommon-20.08.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/mailcommon/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5MailCommon.so.5.15.0
